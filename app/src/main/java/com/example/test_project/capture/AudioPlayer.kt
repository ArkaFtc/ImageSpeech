    ...
    suspend fun play(audio: SpokenAudio) {
        ...
        try {
            ...
            suspendCancellableCoroutine<Unit> { continuation ->
                ...
                if (manager.requestAudioFocus(checkNotNull(focus)) != AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    continuation.resumeWithException(IllegalStateException("Audio output is unavailable"))
